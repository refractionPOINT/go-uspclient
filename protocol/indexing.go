...
type IndexDescriptor struct {
	...
	// some specific ones.
	EventsIncluded []string `json:"events_included,omitempty" yaml:"events_included,omitempty" msgpack:"events_included,omitempty"`
	EventsExcluded []string `json:"events_excluded,omitempty" yaml:"events_excluded,omitempty" msgpack:"events_excluded,omitempty"`
	...
	Regexp string `json:"regexp,omitempty" yaml:"regexp,omitempty" msgpack:"regexp,omitempty"`

	// What index the above field belongs to. Unsupported indexes
	// will result in an error.
	// Like: user
	IndexType string `json:"index_type" yaml:"index_type" msgpack:"index_type"`
}
